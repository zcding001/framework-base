...
import com.basics.framework.core.exceptions.ExcelException;
							...
							case NUMERIC:
								if(HSSFDateUtil.isCellDateFormatted(cell)){
									if(cell.getCellStyle().getDataFormat() == 22){
										msg = new SimpleDateFormat(DateUtils.YYYY_MM_DD_HH_MM_SS).format(cell.getDateCellValue());
									}else if(cell.getCellStyle().getDataFormat() == 14){
										msg = new SimpleDateFormat(DateUtils.YYYY_MM_DD).format(cell.getDateCellValue());
									}
								}else{
