...
import com.basics.framework.core.exceptions.GeneralException;
...
//				add by zc.ding end on 2017.3.27
	 ...
	 * @param parentFile 设定文件
	 * @return List<String> DOM对象
	 * @throws
	 */
    public static List<String> getAllJarProperties(File parentFile) throws IOException {
        List<String> lists = new ArrayList<String>();
...
//		}
        Files.list(Paths.get(parentFile.getAbsolutePath())).filter(o -> o.endsWith("jar"))
                .forEach(o -> lists.addAll(getSpecifiedFileFromJar(o.toFile(), "application.+\\.properties")));
        return lists;
    }
